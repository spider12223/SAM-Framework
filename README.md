...
2. **[Download the installer](https://github.com/spider12223/SAM-Framework/releases/latest)** from GitHub Releases (`SAM_Framework_Installer_v0.9.1.exe`).
...
> Direct download: **[SAM_Framework_Installer_v0.9.1.exe](https://github.com/spider12223/SAM-Framework/releases/download/v0.9.1/SAM_Framework_Installer_v0.9.1.exe)** &nbsp;·&nbsp; To revert to vanilla, rename `barony_vanilla.exe` back to `barony.exe`.
